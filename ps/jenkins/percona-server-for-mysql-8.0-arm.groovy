...
void buildStage(String DOCKER_OS, String STAGE_PARAM) {
    sh """
        ...
        sed -i "/dh_strip/a sed -i 's:dh_strip -Xlibprotobuf-lite:dh_strip -Xlibprotobuf-lite --exclude=debian/percona-server-server/usr/lib/mysql/plugin/authentication_fido.so:' debian/rules" ps_builder.sh
